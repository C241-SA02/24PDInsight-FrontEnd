...
const Orders = () => {
    ...
    return (
        <React.Fragment>
            <BreadCrumb title='Order Lists' pageTitle='History' />
                    ...
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-2 lg:col-start-11">
                            <div className="ltr:lg:text-right rtl:lg:text-left">
                                <Link to="#!" data-modal-target="addOrderModal" type="button" className="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20" onClick={toggle}>
                                    <Plus className="inline-block size-4" /> <span className="align-middle">Add Filter</span>
                                </Link>
                            </div>
                        </div>
                    </div>
                ...
                <Modal.Body className="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                    <form action="#!" onSubmit={(e) => {
                        ...
                        <div className="grid grid-cols-1 gap-4 xl:grid-cols-12">
                            ...
                            <div className="xl:col-span-12">
                                <label htmlFor="detail" className="inline-block mb-2 text-base font-medium">Customer Name</label>
                                <input type="text" id="detail" className="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Customer name"
                                    name="detail"
                                    onChange={validation.handleChange}
